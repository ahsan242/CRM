...
import { getCalculatedPrice } from '@/helpers/brand';
...
const BrandsListTable = ({
  ...
  return <ReactTable columns={columns} data={brands} rowsPerPageList={pageSizeList} pageSize={10} tableClass="text-nowrap mb-0" theadClass="bg-light bg-opacity-50" showPagination />;
};
