...
//   const [statusFilter, setStatusFilter] = useState('inactive'); // Default to inactive only
...
//   const fetchImportedProducts = async (status = 'inactive') => {
//     setLoadingProducts(true);
//     try {
//       let url = '/api/productforimports';
//       if (status !== 'all') {
//         url += `?status=${status}`;
//       }
...
//   useEffect(() => {
//     fetchImportedProducts(statusFilter);
//     fetchImportHistory();
//   }, [statusFilter]);
...
//             fetchImportedProducts(statusFilter);
//             fetchImportHistory();
//             setSelectedProducts([]); // Clear selection after import
//           }
//         } catch (err) {
...
//     try {
//       const productsToImport = filteredImportedProducts
...
//     if (e.target.checked) {
//       setSelectedProducts(currentPageProducts.map(product => product.id));
//     } else {
//       setSelectedProducts([]);
//     }
//   };
...
//   // Pagination
//   const totalPages = Math.ceil(filteredImportedProducts.length / pageSize);
//   const currentPageProducts = useMemo(() => {
//     const startIndex = (currentPage - 1) * pageSize;
//     return filteredImportedProducts.slice(startIndex, startIndex + pageSize);
//   }, [filteredImportedProducts, currentPage, pageSize]);

//   // Statistics with enhanced metrics
//   const stats = useMemo(() => {
//     const total = importedProductsList.length;
...
//     };
//   }, [importedProductsList, selectedProducts]);

//   // Smart batch suggestions based on available products
//   const batchSuggestions = useMemo(() => {
//     const suggestions = [];
//     const brands = [...new Set(importedProductsList.map(p => p.brand))];
    
//     brands.forEach(brand => {
//       const brandProducts = importedProductsList.filter(p => p.brand === brand && p.status === 'inactive');
//       if (brandProducts.length > 0) {
//         suggestions.push({
//           brand,
//           count: brandProducts.length,
//           distributor: brandProducts[0].distributor,
//           description: `${brandProducts.length} inactive products available`
//         });
//       }
//     });
...
//                           </p>
//                           <div className="d-flex justify-content-between align-items-center">
//                             <Badge bg="primary">{suggestion.count} items</Badge>
//                             <Button 
//                               size="sm" 
//                               variant="outline-primary"
...
//                       <div className="d-flex justify-content-between">
//                         <span>Selected:</span>
//                         <Badge bg="info">{stats.selectedCount}</Badge>
//                       </div>
//                       <div className="d-flex justify-content-between">
...
//                                 disabled={product.status === 'active'} // Disable selection for active products
//                               />
//                             </div>
//                           </td>
//                           <td>
...
//                                 )}
//                               </Button>
//                               {/* ACTIVATE IMMEDIATELY BUTTON - ADDED HERE */}
//                               <Button
//                                 variant="outline-success"
//                                 size="sm"
...
//                   <div>
//                     <small className="text-muted">
//                       Showing {currentPageProducts.length} of {filteredImportedProducts.length} products • 
