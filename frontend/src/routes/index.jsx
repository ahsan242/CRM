...
// Apps Routes
const EcommerceBrandCreate = lazy(() => import('@/app/(admin)/ecommerce/brand/create/page'));
...
const EcommerceCategoryCreate = lazy(() => import('@/app/(admin)/ecommerce/category/create/page'));
...
},
{
  ...
  path: '/ecommerce/subcategories/create',
  element: <EcommerceSubCategoryCreate />
},
{
  name: 'Create TechProduct',
  path: '/ecommerce/TechProducts/create',
  element: <EcommerceTechProductCreate />
},
{
  name: 'Create TechProductName',
