...
// /**
//  * Get product counts grouped by all brands
//  */
// export const getProductCountByBrand = async (params = {}) => {
//   try {
//     const response = await api.get('/api/products/count/by-brand', { params });
//     return response.data;
//   } catch (error) {
//     const errorMessage = error.response?.data?.error || error.response?.data?.message || error.message || 'Failed to fetch product counts by brand';
//     throw new Error(errorMessage);
//   }
// };

// /**
//  * Get product counts for specific brands by brand names
//  */
// export const getProductCountBySpecificBrands = async (brands, params = {}) => {
//   try {
//     const queryParams = {
...
//     const response = await api.get('/api/products/count/by-specific-brands', { 
//       params: queryParams 
//     });
//     return response.data;
//   } catch (error) {
//     const errorMessage = error.response?.data?.error || error.response?.data?.message || error.message || 'Failed to fetch product counts for specific brands';
//     throw new Error(errorMessage);
//   }
// };
...
//   getProductCountBySpecificBrands,
...
/**
 * Get product counts by brand and status (active, inactive, pending, failed)
 */
export const getProductCountByBrandAndStatus = async (params = {}) => {
  try {
    const response = await api.get('/api/products/count/by-brand-status', { params });
    return response.data;
  } catch (error) {
    const errorMessage = error.response?.data?.error || error.response?.data?.message || error.message || 'Failed to fetch product counts by brand and status';
    throw new Error(errorMessage);
  }
};

/**
 * Get detailed status breakdown for a specific brand
 */
export const getBrandStatusDetails = async (brandName, params = {}) => {
  try {
    const response = await api.get(`/api/products/count/brand/${brandName}/status-details`, { params });
    return response.data;
  } catch (error) {
    const errorMessage = error.response?.data?.error || error.response?.data?.message || error.message || 'Failed to fetch brand status details';
    throw new Error(errorMessage);
  }
};
...
const ProductAPI = {
  ...
  getProductCountByBrandAndStatus,
  getBrandStatusDetails,
