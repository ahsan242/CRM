...
export const getAllCategoryCategories = async () => {
  await sleep();
  return categoriesData;
};
export const getAllSubCategoryCategories = async () => {
  await sleep();
  return categoriesData;
};
export const getAllTechProductCategories = async () => {
  await sleep();
  return categoriesData;
};
export const getAllTechProductNameCategories = async () => {
  await sleep();
  return categoriesData;
};
